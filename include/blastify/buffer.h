...
#ifndef INCLUDE_BLASTIFY_BUFFER_H_
#define INCLUDE_BLASTIFY_BUFFER_H_
...
bool operator==(const blastify::Buffer& lhs, const blastify::Buffer& rhs);

#endif  // INCLUDE_BLASTIFY_BUFFER_H_
